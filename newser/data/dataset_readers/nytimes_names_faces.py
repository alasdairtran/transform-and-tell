...
@DatasetReader.register('nytimes_names_faces')
class NYTimesNamesFacesReader(DatasetReader):
    ...
    def _read(self, split: str):
        ...
        for article in article_cursor:
            ...
            for pos in image_positions:
                ...
                yield self.article_to_instance(paragraphs, name_indices, image, caption, image_path, article['web_url'], pos, face_embeds)

        article_cursor.close()

    def article_to_instance(self, paragraphs, name_indices, image, caption, image_path, web_url, pos, face_embeds) -> Instance:
