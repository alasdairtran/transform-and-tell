...
@TokenIndexer.register("roberta_rare")
class RareRobertaTokenIndexer(TokenIndexer[int]):
    def __init__(self,
    ...
    def _byte_pair_encode(self, text, context, most_common):
        ...
        for raw_token in raw_tokens:
            ...
            rare_ids = [tid for tid in token_ids
                        if tid not in most_common and tid in context_ids]
