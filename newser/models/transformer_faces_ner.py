...
@Model.register("transformer_faces_ner")
class TransformerFacesNERModel(Model):
    """
    ...
    def forward(self,  # type: ignore
        ...
        caption_ids, target_ids, contexts = self._forward(
            context, image, caption, face_embeds, names)
    ...
    def _forward(self,  # type: ignore
        ...
        name_ids = names[self.index]
        name_masks = name_ids[:, :, 0] == self.padding_idx

        B, N, L = name_ids.shape
        name_ids = name_ids.view(B * N, L)
        ...
        name_embeds[torch.isnan(name_embeds)] = 0
        ...
        contexts = {
            ...
            'names': name_embeds.transpose(0, 1),
