...
To evaluate the quality of the generated captions we also report: caption
...
(\textit{copying}). \verify{Note that all our models use BPE encoding with
adaptive softmax. We keep the total number of trainable parameter for
each
