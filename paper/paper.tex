...
\begin{enumerate}
   \item We introduce the NYTimes+ dataset, containing 446K articles and 794K
   images with captions from the New York Times spanning 14 years. This
   constitutes the largest news image captioning dataset to date. NYTimes+ is
   built upon the GoodNews dataset, but we write a custom parser to collect
   higher-quality articles and metadata such as the location of an image within
   the page.
   ...
   generate names not seen during training.
