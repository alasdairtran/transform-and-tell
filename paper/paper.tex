...
comparison to previous works easier. In the original split, the dataset was
...
In order to study how rare names are generated, we split the training,
validation, and test sets by time. The training set consists of 434K articles
