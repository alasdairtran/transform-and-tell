...
to objects \cite{Wang2019Hierarchical} and concept terms
...
and write a custom parser to recollect and extract all the articles and images
in the same period as GoodNews from the original source. We call this
GoodNews+. We were able to crawl all the original articles, but the number of
