...
\begin{itemize}
   \item We scraped articles and images from the New York Times to create the
   largest news image captioning with 794K images, each with an associated
   caption and article.
   \item We use the transformer architecture and Byte Pair Encoding to develop
   an end-to-end encoder-decoder model that achieves state-of-the-art results
   on news image captioning.
   \item
\end{itemize}
